...
const Register = () => {
  ...
  "
          ...
          {/* Form */}
          <form className="w-[478px] h-[476.15px] flex flex-col gap-[18px] ml-8">
            {/* Full Name */}
            <div className="flex flex-col gap-[8px]">
              <label className="font-[Inter] font-semibold text-[16px] leading-[16px] text-[#0E0E0E]">
  Full Name
</label>
            ...
            <div className="flex flex-col gap-[8px]">
              ...
              <div className={inputWrapperClass}>
                ...
                <button
                  ...
                  className="text-gray-400 hover:text-[#03B5AA]"
                ></button>
              </div>
            </div>
            ...
            <label className="flex items-start gap-2 text-sm text-gray-600">
              <input type="checkbox" className=" w-4 h-4 text-[#023436] bg-danger " />

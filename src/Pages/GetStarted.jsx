...
>
  ...
  />
        ...
        <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left gap-6">
          ...
          {/* Paragraph */}
          <p className="text-[rgba(51,51,51,0.72)] w-full max-w-[478px] font-[Inter] font-medium text-sm sm:text-base leading-[22px] sm:leading-[24px]">
...
"
  ...
  <h4 className="font-[Inter] font-semibold text-[14px]">
    As a Student
  </h4>
  ...
  to="/TravRegister"
  className="
    flex flex-row lg:flex-col items-center lg:items-start gap-3
    w-full
    px-5 py-4
    bg-white
    text-[#212322]
...
>
  ...
  <div className="flex flex-col text-left">
    <h4 className="w-full font-[Inter] font-semibold text-[14px]">
      As a Traveler
    </h4>

    <p className="w-full font-[Inter] text-[12px] text-gray-600">
      exploring global updates.
        ...
        <div className="flex-1 flex justify-center items-center w-full">
          <img
            ...
            className="
              w-full max-w-[600px] lg:max-w-[730px]
              h-[300px] sm:h-[400px] lg:h-[918px]
              rounded-[18px]
              object-cover
            "
          />

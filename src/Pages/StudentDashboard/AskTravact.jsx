...
const AskTravactiv = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen w-full bg-[#F4F7F9] text-[#1A3B34] font-sans overflow-x-hidden">
      
      {/* Chat List Column */}
      <div className="bg-white rounded-xl border border-gray-50 flex flex-col w-full lg:w-[333px] lg:h-[890px] shadow-lg lg:sticky lg:top-8">
            ...
            >
              ...
              {chat.img && (
                <img
                  src={chat.img}
                  alt="Post"
                  className="w-full h-[214px] object-cover rounded-lg mb-2 hover:scale-105 transition-transform duration-300"
                />
              )}
        ...
        <div className="p-4 border-t border-gray-50">
          <button className="w-full h-[44px] rounded-full bg-[#005A58] text-white font-bold text-sm mt-4 hover:bg-teal-800 hover:shadow-md transition-all duration-200">
            New Chat
          </button>
        </div>
      </div>
      ...
      <div className="hidden lg:flex-1 lg:flex lg:flex-col bg-white rounded-xl border border-gray-50 overflow-hidden mt-6 lg:mt-0 shadow-lg">
        
        {/* Header Image */}
        <div className="relative rounded-2xl overflow-hidden mb-8 h-[228px] flex items-end group hover:shadow-lg transition-all duration-300">
          <img
            src={ImgHeader}
            className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
            alt="Background"
          />
          <div className="absolute inset-0 bg-linear-to-t from-black/80 to-transparent" style={{
            background: "linear-gradient(178.45deg, rgba(0,0,0,0) -98.02%, rgba(0,0,0,0.9) 106.45%)",
            backdropFilter: "blur(32px)"
          }}></div>
          <h2 className="absolute text-white text-[32px] leading-tight lg:top-[134px] lg:left-[38px] font-medium">
            Royal Society Wolfson Visiting <br /> Fellowship 2025
          </h2>
        </div>

        {/* Messages */}
        <div className="flex flex-col p-6 space-y-6 mt-64">

...
const AskTravactiv = () => {
  ...
  const handleSend = () => {
    ...
    let botReply = "Sorry, I don't understand that yet. You can ask me about Travactive, visas, scholarships or say hi 👋";

    // 👋 greetings
    if (msg.includes("hello") || msg.includes("hi")) {
      botReply = "Hello 👋 Welcome to Travactive Chat! How can I assist you today?";
    }

    // 🆘 help
    else if (msg.includes("help")) {
      botReply = "Sure 👍 I can help you with scholarships, visas, and information about Travactive.";
    }

    // 🎓 scholarship
    else if (msg.includes("scholarship")) {
      botReply = "We post latest scholarship opportunities like UK, Canada, and more in your chat list 👈";
    }

    // 🛂 visa
    else if (msg.includes("visa")) {
      botReply = "Travactive provides guidance on student visas, post-study work visas, and residency options.";
    }

    // 🏢 about travactive
    else if (msg.includes("what is travactive") || msg.includes("about travactive")) {
      botReply = "Travactive is a platform that helps students and professionals explore scholarships, travel opportunities, and visa guidance worldwide 🌍";
    }
    ...
    // ❓ ask name of bot
      ...
      botReply = "I am Travactive Assistant 🤖 here to guide you with travel and scholarship info.";
    }
